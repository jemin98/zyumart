...
class _SplashState extends State<Splash> {
  ...
  Widget build(BuildContext context) {
    return /*Container(
      ...
      child: Image.asset("assets/splash_login_registration_background_image.png", fit: BoxFit.fill,),
    );*/
      CustomSplashScreen(
      //comment this
      seconds: 3,
      ...
      image: Image.asset("assets/splash_login_registration_background_image.png"),
     /* backgroundImage:
